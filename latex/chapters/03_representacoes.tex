...
\begin{mydef}[Matriz de Adjacência]
  ...
  % TODO : trocar pra notação de função..
  \begin{itemize}
...
% Adicionar exemplo de grafo e suas 3 representações?
...
% (1) front matter, (2) main text, and (3) end matter. %[\textbf{also
% % notice that the preceding sentence is an example of a numbered list
% % in a text body}].
