...
\label{ch:lit_rev} %Label of the chapter lit rev. The key
% ``ch:lit_rev'' can be used with command \ref{ch:lit_rev} to refer
% this Chapter.
...
Take a note of the commands \textbackslash cite\{\} and
...
enable this change, you will need to edit the \path{CS_report.sty}
